...
parser.add_argument('--freqTX_1', default=3e9, type=float,
...
parser.add_argument('--freqTX_2', default=3e9, type=float,
...
parser.add_argument('--freqRX_1', default=3e9, type=float,
    help='Carrier frequency in Hz for channel A')
...
parser.add_argument('--fileRX_2', default='.', type=str,
    help='Binary file to load IQ samples for channel B, \'.\' for not used')
parser.add_argument('--freqRX_2', default=3e9, type=float,
    help='Carrier frequency in Hz for channel B')
    ...
    def __init__(self, opt):
        ...
        if fileTxNum > 0:
            ...
            self.uhd_usrp_sink = uhd.usrp_sink(
                ",".join(("", "addr="+ADDR+", master_clock_rate="+str(CLOCK)+", clock_source="+SYNC+", time_source="+SYNC)),
