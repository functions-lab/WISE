...
# dxl_lib = cdll.LoadLibrary("C:/SWMilliBox/MBX/c/build/linux64/libdxl_x64_c.so")     # for linux 64bit
# dxl_lib = cdll.LoadLibrary("C:/SWMilliBox/MBX/c/build/linux_sbc/libdxl_sbc_c.so")   # for SBC linux
# dxl_lib = cdll.LoadLibrary("C:/SWMilliBox/MBX/c/build/mac/libdxl_mac_c.dylib")      # for Mac OS
