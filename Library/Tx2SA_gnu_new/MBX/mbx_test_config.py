...
def millibox_2dsweep_wrapper(MINH, MAXH, MINV, MAXV, STEP, POL, PLOT, tag, inst, ACCURACY):
    """ wrapper function for 2D sweep """
    ...
    if inst.inst_type.find("SA") > -1 or inst.inst_type == "":                  # spectrum analyzer (or simulated) measurement
        for freq in freqList:                                                   # freq sweep
            ...
            mbxf.millibox_2dsweep(MINH, MAXH, MINV, MAXV, STEP, POL, PLOT, tag_full, inst, ACCURACY, meas_delay, plot_freq=freq)
        ...
        mbxf.millibox_2dsweep(MINH, MAXH, MINV, MAXV, STEP, POL, PLOT, tag_full, inst, ACCURACY, meas_delay, plot_freq=freqList[0])
